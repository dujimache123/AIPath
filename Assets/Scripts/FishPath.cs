...
public class FishPath : ScriptableObject
{
	...
	private float SECOND_ONE_FRAME = 0.03f;
    ...
    private int mSelectedLineIndex_ = -1;
    ...
    {
        get { return mSelectedLineIndex_; }
        set { mSelectedLineIndex_ = value; }
    }
